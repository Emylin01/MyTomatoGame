...
public class StartGUI extends JFrame {
    ...
    public StartGUI() {
    	setResizable(false);
    	setIconImage(Toolkit.getDefaultToolkit().getImage(StartGUI.class.getResource("/tomato/resources/Tomato1.png")));
    	setType(Type.POPUP);
        ...
        ImageIcon imageIcon = new ImageIcon(getClass().getResource("/tomato/resources/Tomato1.png"));
